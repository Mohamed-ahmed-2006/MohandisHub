...
export const NOTIFICATION_NAVIGATION_MAP: Partial<Record<NotificationType, string>> = {
  ...
  wallet_deposit_approved: '/app/settings/wallet',
  wallet_deposit_rejected: '/app/settings/wallet',
  wallet_withdrawal_completed: '/app/settings/wallet',
  wallet_withdrawal_rejected: '/app/settings/wallet',
  wallet_deposit_confirmed: '/app/settings/wallet',
