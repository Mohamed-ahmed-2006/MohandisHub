...
-- --------------------------------------------------------------------------CREATE TABLE IF NOT EXISTS admin_reviews (
  ...
  notes             TEXT,
  created_at        TIMESTAMPTZ NOT NULL DEFAULT now()
);CREATE INDEX IF NOT EXISTS idx_admin_reviews_target_user ON admin_reviews (target_user_id);CREATE INDEX IF NOT EXISTS idx_admin_reviews_reviewer    ON admin_reviews (reviewer_id);
...
-- ============================================================================
-- MohandisHub — v011: Password reset token fields
-- ============================================================================
