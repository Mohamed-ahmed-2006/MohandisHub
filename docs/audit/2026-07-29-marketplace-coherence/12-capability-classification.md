...
**Rule applied throughout:** class 1 and 2 capabilities are _never_ recommended for removal. Class 2 gets integration work. Only class 5 gets repair, and only class 6 gets new build.
...
**Not a candidate for deletion.** It is coherent and complete; the question is whether it is _in_ the launch surface, and whether "Projects" is the right name for it.
