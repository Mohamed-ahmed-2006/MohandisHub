...
**Class 6** · **L** · deps: none · **blocks P1-02, P1-09, P2-*
...
**P2-06 note:** never display a badge the backend does not genuinely verify. `canProBadge` is granted by *plan purchase*. Presenting a paid badge next to identity-verification badges implies verification that has not occurred. Either rename it explicitly ("Pro plan") or back it with real signals.
