...
| Weak | Strong |
|---|---|
| "You have a new notification" | "Ahmed sent a proposal for *Villa structural review* — 3 proposals to compare" |
| "Payment received" | "180 MHC added. Balance: 420 MHC" |
| "Status updated" | "Your provider activated *Villa structural review*. Contact details are now available." |

Every notification should answer: *what happened, to which thing, and what should I do now?*
