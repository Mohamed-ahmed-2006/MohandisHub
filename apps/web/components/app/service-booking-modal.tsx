...
import type { AvailabilitySlot, ServiceSearchResult } from '@mohandishub/shared';
...
export const ServiceBookingModal = ({
  ...
  const loadSlots = useCallback(async () => {
    ...
    try {
      ...
      const res = await availabilityApiClient.listSlots(accessToken, {
  ...
  }, [accessToken, service.providerId, weekStart]);
  ...
  const handleBook = async () => {
    ...
    setError(null);
    try {
      await bookingsApiClient.create(accessToken, {
