...
export const DEGREES: DegreeEntry[] = [
  ...
  { id: 'beng', nameEn: 'Bachelor of Engineering (BEng)', nameAr: 'بكالوريوس هندسة (BEng)' },
  {
    ...
    nameAr: 'بكالوريوس إدارة أعمال (BBA)',
  },
  {
    id: 'barch',
    nameEn: 'Bachelor of Architecture (BArch)',
    nameAr: 'بكالوريوس هندسة معمارية (BArch)',
  },
  ...
  { id: 'meng', nameEn: 'Master of Engineering (MEng)', nameAr: 'ماجستير هندسة (MEng)' },
  {
    ...
    nameAr: 'ماجستير إدارة أعمال (MBA)',
  },
  {
    id: 'march',
    nameEn: 'Master of Architecture (MArch)',
    nameAr: 'ماجستير هندسة معمارية (MArch)',
  },
