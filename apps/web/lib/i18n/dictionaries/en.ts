...
export const enDictionary: Dictionary = {
  ...
  onboarding: {
    ...
    hourlyRateLabel: 'Hourly rate (USD)',
        cityLabel: 'City',
  ...
  wallet: {
    ...
    instapayOptionHint: 'Manual transfer + proof',
    instapayInstructions:
      'Transfer the amount below to the platform InstaPay account, then upload your receipt.',
    ...
    depositMinAmount: 'Minimum card deposit is 50 USD.',
