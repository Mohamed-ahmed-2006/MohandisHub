...
export const enDictionary: Dictionary = {
  ...
  admin: {
    ...
    users: {
      ...
      bulk: {
        ...
        removePlan: 'Remove current plan',
        apply: 'Apply',
        applying: 'Applying…',
        clear: 'Clear',
        limit: 'Maximum 100 explicit users',
        selectPage: 'Select all users on this page',
        confirm: 'Apply “{action}” to {count} users?',
        deletePrompt: 'Type {expected} to soft-delete {count} selected users.',
        completed: 'Completed: {succeeded} succeeded, {skipped} skipped, {failed} failed.',
      },
      userDetail: {
        title: 'User Details',
  ...
  wallet: {
    ...
    instapaySenderLabel: 'Sender InstaPay number / account',
    instapaySenderPlaceholder: 'e.g. +2010xxxxxxx or wallet account',
    instapaySenderRequired: 'Sender InstaPay number/account is required.',
    instapayReferenceLabel: 'Transfer reference (optional)',
    instapayReferencePlaceholder: 'Bank or InstaPay reference',
