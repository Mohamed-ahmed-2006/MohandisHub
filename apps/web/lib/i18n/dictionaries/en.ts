  ...
  admin: {
    ...
    users: {
      ...
      userDetail: {
        ...
        createdAt: 'Joined',
        adminFlag: 'Admin user',
        verificationHistory: {
          title: 'Verification review history',
          hint:
            'Past approve/reject actions for this user (including older identity document IDs if they resubmitted after rejection).',
          empty: 'No past admin reviews yet.',
          date: 'Date',
          reviewer: 'Reviewer',
          type: 'Type',
          decision: 'Decision',
          ...
          typeAcademic: 'Academic record',
          typeBusiness: 'Business (company) verification',
          approved: 'Approved',
          rejected: 'Rejected',
        },
      },
