...
export const arDictionary: Dictionary = {
  ...
  notificationTemplates: {
    ...
    resolution_case_opened: {
      title: 'تم فتح قضية تخصك',
      message: 'القضية {referenceCode} تخصك. افتحها للرد.',
    },
    resolution_case_message: {
      title: 'رسالة جديدة في القضية',
      message: 'هناك رسالة جديدة في القضية {referenceCode}.',
    },
    resolution_case_escalated: {
      title: 'تم تصعيد القضية',
      message: 'تم تصعيد القضية {referenceCode} لمراجعة الإدارة.',
    },
    resolution_case_status_changed: {
      title: 'تحديث القضية',
      message: 'تغيرت حالة القضية {referenceCode}.',
    },
    resolution_case_resolved: {
      title: 'تم حل القضية',
      message: 'تم حل القضية {referenceCode}.',
    },
  ...
  helpResolutionPage: {
    title: 'مركز الدعم وحل النزاعات',
    intro: 'تذاكر الدعم ونزاعات السوق ومشكلات الدفع وبلاغات السلامة في مكان واحد.',
    newCase: 'قضية جديدة',
    allCases: 'جميع القضايا',
    generalSupport: 'الدعم العام',
    marketplaceDisputes: 'نزاعات السوق',
    safetyAndPayments: 'السلامة والمدفوعات',
    searchPlaceholder: 'ابحث في القضايا...',
    statusAll: 'الكل',
    statusActive: 'نشط',
    statusClosed: 'مغلق',
    noCases: 'لم يتم العثور على قضايا مطابقة.',
    selectCase: 'اختر قضية لعرض المحادثة والتفاصيل.',
    reference: 'الرقم المرجعي',
    evidenceTitle: 'ملفات الأدلة',
    noEvidence: 'لا توجد أدلة مرفقة حتى الآن.',
    evidenceLabelPlaceholder: 'وصف الدليل',
    openFile: 'فتح الملف',
    evidenceOpenFailed: 'تعذر فتح هذا الملف بشكل آمن. حاول مرة أخرى.',
    composerPlaceholder: 'أضف رسالة إلى هذه القضية...',
    postMessage: 'إرسال',
    escalate: 'تصعيد إلى الإدارة',
    escalateConfirm: 'هل تريد تصعيد هذه القضية لمراجعة الإدارة؟',
    escalated: 'مُصعّدة',
    caseClosedNotice: 'هذه القضية مغلقة. افتح قضية جديدة إذا كنت لا تزال بحاجة إلى مساعدة.',
    categoryLabel: 'ما موضوع القضية؟',
    subjectLabel: 'أي ارتباط؟',
    reasonLabel: 'السبب',
    summaryLabel: 'الموضوع',
    detailsLabel: 'التفاصيل',
    reportedUserLabel: 'الحساب المُبلّغ عنه (اختياري)',
    submit: 'إرسال القضية',
    cancel: 'إلغاء',
    kindGeneralSupport: 'دعم المنصة العام',
    kindNeedJobDispute: 'نزاع طلب أو وظيفة',
    kindReservationDispute: 'نزاع حجز',
    kindDirectPayment: 'مشكلة دفع مباشر',
    kindSafetyReport: 'بلاغ سلامة أو انتهاك',
    reservationDisputeHint:
      'تُفتح نزاعات الحجز من الحجز نفسه حتى تتم تسوية المبلغ مع القرار. تابع إلى حجوزاتك.',
    goToBookings: 'الانتقال للحجوزات',
    unavailableNoEligibleSubject: 'لا يوجد لديك ارتباط يدعم هذا النوع من القضايا حتى الآن.',
    unavailableLifecycle: 'هذا النوع من القضايا غير متاح للعنصر المحدد.',
    checkingAvailability: 'جارٍ التحقق مما يمكنك فتحه...',
    loadFailed: 'تعذر تحميل قضاياك.',
    createFailed: 'تعذر إنشاء القضية.',
    messageFailed: 'تعذر إرسال الرسالة.',
    evidenceFailed: 'تعذر إرفاق الدليل.',
    duplicateCase: 'لديك بالفعل قضية مفتوحة بخصوص هذا. تابع في القضية الحالية.',
    totalCases: 'إجمالي القضايا',
    activeCases: 'قضايا نشطة',
    closedCases: 'قضايا مغلقة',
    awaitingUserCases: 'في انتظار ردك',
    underReviewCases: 'قيد المراجعة',
    backToList: 'العودة لقائمة القضايا',
    caseDetailsTitle: 'تفاصيل القضية',
    attachEvidence: 'إرفاق ملف دليل',
    clearSearch: 'مسح البحث',
    statsOverview: 'نظرة عامة',
    statusOpen: 'مفتوحة',
    statusAwaitingUser: 'في انتظار ردك',
    statusUnderReview: 'قيد المراجعة',
    statusResolved: 'تمت التسوية',
  },
  appHome: {
